function [dT,flm,flv,Crt,fl]=migration_ini(f,Ti,pm)

% Creates mass, energy, volume change in lithosphere layer
...
Q0=zeros(size(f));         % energy matrix from crystallize material within lid, in J
